    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                    <img src="{{ asset('img/w1.jpg') }}" alt="Куриян Роман" class="w-full h-72 object-cover object-top">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                    <img src="{{ asset('img/w2.jpg') }}" alt="Катырев Алексей"
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                    <img src="{{ asset('img/w3.jpg') }}" alt="Кузьменко Егор"
                        class="w-full h-72 object-cover object-top">
                    <div class="absolute bottom-0 w-full bg-white bg-opacity-90 p-4 text-center">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden relative">
                    <img src="{{ asset('img/w4.jpg') }}" alt="Рябцев Никита"
                        class="w-full h-72 object-cover object-top">
                    <div class="absolute bottom-0 w-full bg-white bg-opacity-90 p-4 text-center">
                        <h3 class="text-lg font-semibold text-blue-900">Рябцев Никита</h3>
        ...
        <section class="mb-12 text-center">
            ...
            <div class="relative w-full max-w-4xl mx-auto">
                <iframe class="w-full h-[500px]" src="https://rutube.ru/play/embed/89733770b249072c2145f4580b82717b/"
                    title="RuTube video player" frameborder="0"
