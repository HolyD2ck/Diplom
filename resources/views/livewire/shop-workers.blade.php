        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <section class="text-center mb-12">
                ...
                <div class="mt-4 w-full h-48 sm:h-64 bg-cover bg-center rounded-lg shadow-md"
                    style="background-image: url('https://belvebhub.by/uploads/redd_PT_Rzqc_h1r4_unsplash_462497c8fe.jpg');">
                </div>
            </section>

            <!-- Наши сотрудники -->
            <section class="text-center mb-12 bg-gradient-to-r from-blue-50 to-blue-100 py-12">
                <div class="container mx-auto px-6">
                    <div class="p-6 bg-blue-500 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300">
                        <h2 class="text-3xl font-semibold text-white mb-8">Наши сотрудники</h2>
                        <br>
                        <!-- Сетка сотрудников -->
            ...
            <section class="mb-12">
                ...
                <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md">
                    <form class="space-y-4" wire:submit.prevent="submitResume">
                        ...
                        <button type="submit"
                            class="w-full px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm sm:text-base">Отправить
                            резюме</button>
                    </form>
                </div>
            </section>
